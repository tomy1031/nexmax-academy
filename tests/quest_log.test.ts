 ...
 *
 * `lint:content` が 見るのは 教材データ（JSON）だけ。**コードが 組み立てる 文**の
 * 読みは いまも どの 機械検査にも かからない（クエストの 教材そのものは
 * 2026-09-11 に `collectLabeledTexts` へ 入ったが、ログの 文は その 外側）。
 * その 穴で 2つ 出て いた（2026-09-11）:
