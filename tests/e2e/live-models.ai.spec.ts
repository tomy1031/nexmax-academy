 ...
 * 見かた・たいわ・声の つなぎは 開けなければ 黙って 次の 名前へ 落ちる——3.8 が 断っても 3.1 で
 * 緑に なる（2026-09-16 までは たいわと 声が 先頭しか ためさず、断られると 声が 全部 止まって いた。
 * 落ちる 仕組みそのものは `live-fallback.ai.spec.ts` が 見る）。
