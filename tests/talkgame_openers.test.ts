 ...
 *
 * 直しは **準備の 数に しつもんを そろえる**（本人の 指定）。いまは 準備 6問／しつもん 5本で、
 * ①〜⑤ が 出だしの しつもんと 1対1、⑥ は 聞く ばん（学生が しつもんする ばん）の ぶん。
 * あまった しつもんは 消し、そこから 先は AIが 学習者の ことばから 深掘りを 作る。
 *（2026-08-31 に「Japanese IT Pathway は どんな プログラム？」を 準備からも しつもんからも 外した。）
 *
