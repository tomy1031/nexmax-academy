...
export default function AdminPage() {
  ...
  if (loading) {
    return (
      <main className="bg-bg-sky grid min-h-dvh place-items-center">
  ...
  return (
    <main className="from-bg-sky to-bg-warm min-h-dvh bg-linear-to-b px-4 py-8">
      <section className="card-pop mx-auto max-w-[96rem] p-5 sm:p-8">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <Link href="/map" className="text-sky font-bold underline underline-offset-4">
            ← マップへ
          </Link>
        </div>
