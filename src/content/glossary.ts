...
export const GLOSSARY: readonly GlossaryEntry[] = [
  ...
  // --- 20問に出るN5超えの語（07 §3.0.2）。かな書きをやめて漢字＋ふりがなにし、意味はここで出す ---
  {
    term: "元気",
    kanji: "元気",
    reading: "げんき",
    meaning: "体と こころに 力が ある こと",
    englishTerm: "energy",
    englishMeaning: "feeling well and full of energy",
  },
  {
    term: "説明",
    kanji: "説明",
    reading: "せつめい",
    meaning: "わかるように 話す こと",
    englishTerm: "explanation",
    englishMeaning: "telling someone about it so they understand",
  },
  {
    term: "予定",
    kanji: "予定",
  ...
  },
  {
    ...
    kanji: "失敗",
    reading: "しっぱい",
    meaning: "やって みたが、うまく いかない こと",
    englishTerm: "failure",
    englishMeaning: "trying something and it not going well",
  },
  {
    term: "道具",
    kanji: "道具",
    reading: "どうぐ",
    meaning: "しごとや べんきょうに 使う もの",
    englishTerm: "tool",
    englishMeaning: "a thing you use to do work",
  },
  {
    term: "大切",
    kanji: "大切",
    reading: "たいせつ",
    meaning: "とても いい・なくしたくない と 思う こと",
    englishTerm: "important",
    englishMeaning: "something you value and do not want to lose",
  },
  {
    term: "気持ち",
    kanji: "気持ち",
    reading: "きもち",
    meaning: "うれしい・かなしい など、こころの ようす",
    englishTerm: "feelings",
    englishMeaning: "how you feel inside — happy, sad, and so on",
  },
  {
    term: "質問",
    kanji: "質問",
    reading: "しつもん",
    meaning: "わからない ことを 聞く こと",
    englishTerm: "question",
    englishMeaning: "asking about something you do not know",
  },
  {
    term: "考え方",
    kanji: "考え方",
    reading: "かんがえかた",
    meaning: "ものごとを どう 見て、どう 思うか",
    englishTerm: "way of thinking",
    englishMeaning: "how you look at things and what you make of them",
  },
  {
    term: "アイデア",
    kanji: null,
    reading: "アイデア",
    meaning: "「こう したら いいかも」と 思いついた こと",
    englishTerm: "idea",
    englishMeaning: "something you thought of that might work",
  },
  {
    term: "チーム",
    kanji: null,
    reading: "チーム",
    meaning: "いっしょに しごとを する 人たち",
    englishTerm: "team",
  ...
  },
  {
    ...
    kanji: null,
    reading: "プログラム",
    meaning: "コンピュータを 動かす ために 書く もの",
    englishTerm: "program",
    englishMeaning: "the code written to make a computer work",
  },
  {
    term: "アプリ",
    kanji: null,
    reading: "アプリ",
    meaning: "スマホや パソコンで 使う どうぐ",
    englishTerm: "app",
    englishMeaning: "software you use on a phone or computer",
  },
] as const;
