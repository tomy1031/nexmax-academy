  ...
  return (
    <div className="space-y-4">
      ...
      <StudioSection
        ...
        hint="まえおきの 画面では **題の すぐ 下**に、聞いて いる 間と 答え合わせの あとは いちばん 上に 出ます（Zoom風の 画面に した ときは 顔の 下）。**答えを 描かない こと**——「どこで 働くか」「何を 作るか」を 絵で 見せると、聞かずに 答えられて しまいます。描いて よいのは だれが・どこで の ところまでです。"
      >
        <ImageSlotEditor
