...
export function MeetingSession({
  ...
  /**
   * 相手（Live）に 渡す 指示。組み立ては `src/lib/meeting/instructions.ts` が 持つ。
   *
   * **画面の 外に 出して ある**のは、管理画面が **保存する 前の 下書きで
   * 組み上げて 全文を 見せる**ため（2026-08-22 の 依頼）。ここに 置いた ままだと、
   * 先生は 何を 渡して いるのかを 見る 手段が 無い。
   */
