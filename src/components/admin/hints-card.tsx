  ...
  return (
    <section className="card-pop mt-6 p-5 sm:p-6">
      ...
      {/* 回答言語の注記。条件を付けない（08 §5.2-2）。
          言語の内訳は書かない——診断の画面から英語を外した（2026-08-19）ので
          「やさしい日本語・日本語・英語のいずれか」は今の画面と合わず、
          かといって英語で答えた過去の回答も残っているため。
          **注記の役目は内訳ではなく「母語ではない」こと**なので、そこだけを言う。
          （08 §5.2-2 の引用文は英語を含む古い形。設計書の更新は別タスク） */}
      <p className="bg-sun/20 text-ink mt-3 rounded-xl px-3 py-2 text-xs font-bold">
        この回答は、本人にとって第2・第3の言語で行われています。発言が少ないことは、日本語への不安によることがあります。
      </p>
